...
#define ALLOC(type,number)  ((type *)dalloc((unsigned)(sizeof(type)*(number))))
#define REALLOC(ptr,type,number)  \
           ptr = (type *)drealloc((char *)ptr,(unsigned)(sizeof(type)*(number)))
#define FREE(ptr) { if ((ptr) != NULL) dfree((char *)(ptr)); (ptr) = NULL; }
